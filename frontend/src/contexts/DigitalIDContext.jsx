...
const initialRequests = [
  {
    id: 1, resident: 'Abebe Girma',      unit: 'A-101', email: 'abebe.girma@email.com',
    requestDate: '2026-02-27', status: 'pending',
    note: 'First-time ID request (new resident)',
    assignedSE: '', assignedEmployee: '', dueDate: '', idNumber: '',
  },
  {
    id: 2, resident: 'Tigist Bekele',    unit: 'B-205', email: 'tigist.bekele@email.com',
    requestDate: '2026-02-25', status: 'approved',
    note: 'Renewal request',
    assignedSE: 'Hiwot Mengistu', assignedEmployee: '', dueDate: '', idNumber: '',
  },
  {
  ...
  },
  {
    ...
    assignedSE: 'Temesgen Alemu', assignedEmployee: 'Selam Wondimu', dueDate: '2026-03-03', idNumber: '',
  },
  {
    id: 5, resident: 'Dawit Tesfaye',    unit: 'B-108', email: 'dawit.tesfaye@email.com',
