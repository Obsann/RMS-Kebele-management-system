...
export default function AdminDashboard() {
  ...
  const upcomingTasks = [
    { id: 1, task: 'Fix broken pipe - Unit A-101', employee: 'John Martinez', priority: 'High', dueDate: 'Today' },
    { id: 2, task: 'Install new light fixtures - Unit B-205', employee: 'David Lee', priority: 'Medium', dueDate: 'Tomorrow' },
    { id: 3, task: 'AC maintenance - Unit C-312', employee: 'Robert Chen', priority: 'Low', dueDate: 'Nov 21' },
  ];
