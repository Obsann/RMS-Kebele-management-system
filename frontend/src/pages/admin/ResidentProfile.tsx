...
export default function AdminResidentProfile() {
  ...
  const certificates = [
    { id: 1, type: 'ID Card', status: 'approved' as const, uploadDate: '2024-01-15', approvedBy: 'Admin' },
    { id: 2, type: 'Proof of Address', status: 'approved' as const, uploadDate: '2024-01-15', approvedBy: 'Admin' },
    { id: 3, type: 'Employment Letter', status: 'pending' as const, uploadDate: '2025-11-18', approvedBy: '-' },
  ];
  ...
  const handleRejectCertificate = (certId: number) => {
            ...
            {activeTab === 'personal' && (
              <div className="space-y-4">
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-gray-600 mb-1">Unit Number</label>
                    <p className="text-gray-900">{resident.unit}</p>
                  </div>
                  <div>
                    <label className="block text-gray-600 mb-1">Join Date</label>
                    <p className="text-gray-900">{resident.joinDate}</p>
                  </div>
                  <div>
                    <label className="block text-gray-600 mb-1">Emergency Contact</label>
                    <p className="text-gray-900">{resident.emergencyContact}</p>
                  </div>
                </div>
              </div>
            )}
