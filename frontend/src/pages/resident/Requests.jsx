...
export default function ResidentRequests() {
  ...
  const requests = [
    { id: 1, type: 'maintenance', subject: 'Leaking pipe in kitchen', category: 'Plumbing', description: 'Pipe under sink is leaking steadily.', status: 'in-progress', date: '2026-02-24', response: 'Technician assigned — Yonas Kebede' },
